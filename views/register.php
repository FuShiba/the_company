                ...
                <div class="card-body">
                    <form action="../actions/register-action.php" method="post" autocomplete="off">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="password" name="password" id="password" class="form-control fw-bold" maxlength="8" area-describedBy="password-info" required>
                    ...
                    <div class="text-center mt-3 small">kredo @ 2024 * Test2</div>
                </div>
            </div>
        </div>
    </div>
